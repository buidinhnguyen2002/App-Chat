    ...
    return (
        <div>
            ...
            {video !== '' ? <div className={`message_container ${props.name === myName ? 'message_container-flexRight':'message_container-flexleft'}`}>
                ...
                {(props.name !== myName &&props.type === 1) && (<span className={"author_chat"}>{props.name}</span>)}
            </div> : videoCall != null || audioCall != null || audioCallFailed == true || videoCallFailed == true ? <div className={`message_container d-flex ${props.name === myName ? 'message_container-flexRight':'message_container-flexleft'}`} >
                {props.name !== myName && <div className="message_avatar">
                    <img src={urlAvatar} alt=""/>
                    {/*<img src="data:image/jpeg;base64," alt=""/>*/}
                </div>}
                <div className={'flex-container d-flex video_call-wrapper'} onClick={()=>videoCallFailed== true || audioCallFailed == true ? null : handelJoinVideoCall(videoCall != null ? videoCall : audioCall)}>
